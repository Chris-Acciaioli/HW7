...
# Your student id: #53953577
# Your email: chrisacc@umich.edu
# List who you have worked with on this project: Erik Martin
...
def nationality_search(countries, cur, conn):
    ...
    for i in range(len(countries)):
        cur.execute('SELECT name, position, nationality FROM Players WHERE nationality = ?', (countries[i],))
        list_of_tup.extend(cur.fetchall())
